...
import "./style/ManageBookingsPage.css";
...
const ManageBookingsPage = () => {
  ...
  return (
    <div className="cb-bookings-container">
      <h2>All Bookings</h2>
      ...
      <div className="cb-booking-results">
        {currentBookings.map((booking) => (
          <div key={booking.id} className="cb-booking-result-item">
            <p>
            ...
            <button
              ...
              onClick={() =>
                navigate(
                  `/cabin-booking/admin/edit-booking/${booking.bookingConfirmationCode}`
                )
              }
            >
              Manage Booking
