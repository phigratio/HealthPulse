...
//   useEffect(() => {
//     // Extract amount and orderId (or bookingId, appointmentId) from URL
//     const params = new URLSearchParams(window.location.search);
//     const urlAmount = params.get("amount");
//     const urlOrderId = params.get("orderId"); // or bookingId, appointmentId

//     if (urlAmount) setAmount(urlAmount);
//     if (urlOrderId) setOrderId(urlOrderId); // storing orderId but not using it further
//   }, []);
