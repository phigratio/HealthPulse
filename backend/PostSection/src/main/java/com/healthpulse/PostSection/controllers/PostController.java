...
import com.healthpulse.PostSection.config.AppConstants;
...
import com.healthpulse.PostSection.services.FileService;
import com.healthpulse.PostSection.services.PostService;
...
//	create
	...
	public ResponseEntity<List<PostDto>> getPostsByUser(@PathVariable ("userId") String userId) {
	...
	public ResponseEntity<List<PostDto>> getPostsByCategory(@PathVariable ("categoryId") String categoryId) {
